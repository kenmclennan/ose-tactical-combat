...
**GM:** "Guardian A attacks Kael with its halberd!" (Melee Attack, two-handed - 4 AP, but it only has 3 AP!)
...
"Guardian B attacks Kael!" (Melee Attack - 4 AP, but it also only has 3 AP!)
...
**Fury Pool:** Zara's leftover 1 AP goes into the Fury Pool. The party now has **1 Fury**.
...
**Sarah:** "Kael advances and attacks!" (Full Move 3 AP + Melee Attack 3 AP = 6 AP)
...
Kael swings with his Aid bonus: rolls 11 + 1 STR + 2 Aid = 14, hitting AC 5. Hit! He rolls damage: 5.

**Sarah:** "That's only 10 total damage on this one. Four hit dice - it's probably still up."

**Marcus:** "Spend our Fury point. Put it down."

**Sarah:** "Spending 1 Fury for +1 damage!"

**Fury Pool:** 1 → 0.

Six damage. Kael's blade catches the Guardian beneath its jaw, wrenching upward with every ounce of strength. The skull splits. It collapses in a heap of ancient bone and rusted armor.
