...
export const ACTIONS: Record<ActionId, ActionDefinition> = {
  // Move actions
  "move-half": { id: "move-half", name: "Move (Half)", cost: 2, description: "Half encounter move (max 2 per round)", category: "move", displayOrder: 0 },
  "move-full": { id: "move-full", name: "Move (Full)", cost: 3, description: "Full encounter move", category: "move", displayOrder: 1 },
  "fighting-withdrawal": { id: "fighting-withdrawal", name: "Fighting Withdrawal", cost: 3, description: "Half move backward, no AC penalty", category: "move", displayOrder: 2 },
  retreat: { id: "retreat", name: "Retreat", cost: 4, description: "Full move backward, foes get +2 to hit you", category: "move", displayOrder: 3 },
  charge: { id: "charge", name: "Charge", cost: 5, description: "Full move + attack, +2 to hit, -2 AC until next turn", category: "move", displayOrder: 4 },
  ...
  // Other actions
  wait: { id: "wait", name: "Wait", cost: 1, description: "Hold or set trigger to interrupt (not in melee)", category: "other", displayOrder: 0 },
  "quick-action": { id: "quick-action", name: "Quick Action", cost: 2, description: "Draw/drop weapon, take cover, stand up, open door", category: "other", displayOrder: 1 },
  brace: { id: "brace", name: "Brace", cost: 2, description: "Ready vs charge; free attack if charged (spear/polearm)", category: "other", displayOrder: 2 },
  aid: { id: "aid", name: "Aid", cost: 2, description: "Ally gets +2 to next attack OR +2 AC until your next turn", category: "other", displayOrder: 3 },
  guard: { id: "guard", name: "Guard", cost: 2, description: "Take attacks meant for adjacent ally (use your AC)", category: "other", displayOrder: 4 },
  "coordinated-defence": { id: "coordinated-defence", name: "Coordinated Defence", cost: 2, description: "All in formation get +1 AC; pay each round; move together", category: "other", displayOrder: 5 },
